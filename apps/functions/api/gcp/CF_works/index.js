...
function requireNode () {
	...
	(function (module, exports) {
		...
		try {
			...
			const supportsColor = requireBrowser$1();
...
function query(payload) {
    return __awaiter(this, void 0, void 0, function* () {
        const res = yield axios(envVars.PUBLIC_HASURA_API_URL || '', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
  ...
  mutation CreateApp($name: String!) {
    insert_app_one(object: {name: $name}) {
      ...
      name
        ...
        try {
            const response = yield hasura.mutate(payload);
            if (!response.data)
...
function createAdmin(email, app_id) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        const mutation = `
    mutation CreateUser($email: String!, $app_id: uuid!) {
      insert_user_one(object: {email: $email, app_id: $app_id, role: "CUSTOMER"}) {
        ...
        try {
            const response = yield hasura.mutate(payload);
            return (_a = response.data) === null || _a === void 0 ? void 0 : _a.insert_user_one;
        }
        catch (error) {
...
function SorcelAppCreator() {
    return {
        createApp: (name) => __awaiter(this, void 0, void 0, function* () {
            const response = yield createApp(name);
            return response || null;
        }),
        createAdmin: (email, appId) => __awaiter(this, void 0, void 0, function* () {
            const response = yield createAdmin(email, appId);
            return response || null;
        }),
    };
}
...
const hello = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const appTest = yield _app.createApp("testapp");
    const _test = helloWorld();
    let user = undefined;
    user = yield testUserPromise();
