...
var require_supports_color = __commonJS({
  "../../../../node_modules/debug/node_modules/supports-color/index.js"(exports, module2) {
    "use strict";
    var os = require("os");
    var tty = require("tty");
    ...
    function getSupportLevel(stream3, options = {}) {
...
// src/index.ts
var appCreator = AppCreatorService(SorcelAppCreator());
