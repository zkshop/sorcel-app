...
export { app as index, getStripeAccount, createApp, updatePlan, getPaperWallet, connectWithEmail, login, createStripeAccount, paymentIntents, getPaperToken, id, verify, isGranted, address };