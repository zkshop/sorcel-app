...
export { app as index, createApp, getStripeAccount, isGranted, updatePlan, login, verify, createStripeAccount, connectWithEmail, id, getPaperWallet, getPaperToken, paymentIntents, address };