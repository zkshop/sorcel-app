...
export { app as index, isGranted, updatePlan, getStripeAccount, createApp, connectWithEmail, paymentIntents, login, id, getPaperToken, getPaperWallet, createStripeAccount, address, verify };