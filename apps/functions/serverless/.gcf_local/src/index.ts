...
export { app as index, createApp, updatePlan, getStripeAccount, isGranted, connectWithEmail, id, login, getPaperToken, paymentIntents, verify, getPaperWallet, createStripeAccount, address };