...
export { app as index, createLog, updatePlan, getStripeAccount, createApp, connectWithEmail, isGranted, login, getPaperWallet, getPaperToken, id, verify, createStripeAccount, signin, paymentIntents, payload, address };