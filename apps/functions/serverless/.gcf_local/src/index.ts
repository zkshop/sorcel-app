...
export { app as index, createApp, updatePlan, connectWithEmail, getStripeAccount, login, paymentIntents, getPaperToken, createStripeAccount, verify, isGranted, getPaperWallet, id, address };