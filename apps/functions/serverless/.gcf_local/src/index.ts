...
export { app as index, createApp, connectWithEmail, updatePlan, paymentIntents, getPaperWallet, id, isGranted, address, getStripeAccount, verify, login, getPaperToken, createStripeAccount };