...
export { app as index, createApp, getStripeAccount, connectWithEmail, updatePlan, login, id, getPaperToken, getPaperWallet, createStripeAccount, paymentIntents, verify, isGranted, address };