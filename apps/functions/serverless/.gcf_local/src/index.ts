...
export { app as index, createApp, updatePlan, isGranted, getStripeAccount, login, getPaperWallet, paymentIntents, createStripeAccount, getPaperToken, verify, connectWithEmail, address, id };