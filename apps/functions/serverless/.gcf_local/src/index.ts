...
export { app as index, createApp, isGranted, updatePlan, connectWithEmail, getPaperToken, createStripeAccount, getStripeAccount, getPaperWallet, address, id, paymentIntents, login, verify };