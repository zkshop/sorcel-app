...
export { app as index, createApp, getStripeAccount, login, updatePlan, isGranted, verify, connectWithEmail, getPaperWallet, createStripeAccount, getPaperToken, paymentIntents };