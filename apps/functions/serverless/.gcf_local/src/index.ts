...
export { app as index, createApp, getStripeAccount, connectWithEmail, updatePlan, getPaperWallet, getPaperToken, id, address, login, createStripeAccount, isGranted, verify, paymentIntents };