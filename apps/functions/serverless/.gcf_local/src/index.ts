...
export { app as index, createApp, createLog, getStripeAccount, login, updatePlan, createStripeAccount, getPaperToken, paymentIntents, signin, connectWithEmail, payload, verify, isGranted, getPaperWallet, id, address };