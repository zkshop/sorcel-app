...
export { app as index, createApp, getStripeAccount, createLog, isGranted, createStripeAccount, login, updatePlan, signin, payload, paymentIntents, connectWithEmail, getPaperToken, verify, id, address, getPaperWallet };