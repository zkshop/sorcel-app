...
export { app as index, createApp, getStripeAccount, connectWithEmail, updatePlan, getPaperToken, id, createStripeAccount, isGranted, paymentIntents, verify, login, address, getPaperWallet };