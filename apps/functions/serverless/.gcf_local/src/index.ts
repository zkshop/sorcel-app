...
export { app as index, isGranted, createLog, updatePlan, createApp, getStripeAccount, connectWithEmail, createStripeAccount, id, login, getPaperWallet, verify, signin, getPaperToken, address, paymentIntents };