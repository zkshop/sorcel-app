...
export { app as index, createApp, getStripeAccount, isGranted, login, createStripeAccount, connectWithEmail, verify, updatePlan, id, address, getPaperWallet, paymentIntents, getPaperToken };