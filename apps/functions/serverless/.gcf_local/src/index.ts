...
export { app as index, createApp, isGranted, updatePlan, getStripeAccount, connectWithEmail, getPaperToken, createStripeAccount, getPaperWallet, id, paymentIntents, address, login, verify };