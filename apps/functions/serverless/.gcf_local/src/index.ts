...
export { app as index, updatePlan, isGranted, createLog, createApp, getStripeAccount, connectWithEmail, getPaperWallet, createStripeAccount, login, signin, payload, id, getPaperToken, paymentIntents, verify, address, payment };