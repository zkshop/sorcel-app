...
export { app as index, createApp, connectWithEmail, isGranted, updatePlan, getPaperWallet, paymentIntents, address, id, getPaperToken, getStripeAccount, createStripeAccount, login, verify };