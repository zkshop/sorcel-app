...
export { app as index, createApp, getStripeAccount, isGranted, connectWithEmail, login, getPaperToken, updatePlan, getPaperWallet, id, address, paymentIntents, verify, createStripeAccount };