...
export { app as index, getStripeAccount, updatePlan, createApp, createLog, createStripeAccount, login, isGranted, connectWithEmail, getPaperWallet, verify, getPaperToken, id, payload, signin, paymentIntents, address };