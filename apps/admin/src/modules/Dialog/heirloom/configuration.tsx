...
import { Box, Button, Checkbox, Code, CopyIcon, FormControl, FormLabel, Input, Text } from '@3shop/ui';
  ...
  return (
    <Box padding="20px">
      <Text marginBottom="10px">
        When creating your lock, please copy the following CORS domain into the CORS field of your form.
      </Text>
