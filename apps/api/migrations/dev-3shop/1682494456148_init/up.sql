...
CREATE TABLE public.product (
    ...
    description text NOT NULL,
    image text NOT NULL,
    "isDiscountGated" boolean DEFAULT false NOT NULL,
    discount integer,
    name text NOT NULL,
    "poapId" integer,
...
ALTER TABLE ONLY public.gate_v2
    ADD CONSTRAINT gate_v2_product_id_fkey FOREIGN KEY (product_id) REFERENCES public.product(id);
ALTER TABLE ONLY public."order"
...
ALTER TABLE ONLY public.product
    ADD CONSTRAINT product_utility_fkey FOREIGN KEY (utility) REFERENCES public.utility(value);
ALTER TABLE ONLY public.segment
