...
export const CreateGateV2Document = gql`
  ...
  insert_gate_v2_one(
    object: {discount: $discount, exclusive_access: $exclusive_access, name: $name, product_id: $product_id, unique_claim: $unique_claim, chain: $chain}
  ) {
    id
    discount
    name
